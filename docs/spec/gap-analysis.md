...
| §4 | Mid-trade change ≤ 1s | ✅ **fixed (G1)** — amend works while halted | `executor.amend_sltp`, `test_sltp_can_still_be_amended_while_halted` |
| §4 | Entry fan-out ~1s | ✅ | `test_fanout.py` timing assertions |
