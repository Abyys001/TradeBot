...
import { SourceMapConsumer } from 'file:///app/node_modules/nitropack/node_modules/source-map/source-map.js';
...
storage.mount('cache:nuxt:payload', cacheDriver({"base":"/app/.nuxt/cache/nuxt/payload"}));
...
const _inlineRuntimeConfig = {
  ...
  "apiProxyTarget": "http://backend:8000/api"
};
const envOptions = {
  prefix: "NITRO_",
...
const _noj80b_Re_E2LuC3bxfueDRkzdKgcjIYVzSNooEUw = (function(nitro) {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, viewport-fit=cover"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"data-theme":"dark"}};
...
const plugins = [
  _noj80b_Re_E2LuC3bxfueDRkzdKgcjIYVzSNooEUw,
...
const _lazy_Sjstzh = () => Promise.resolve().then(function () { return ____path_$1; });
...
const handlers = [
  ...
  { route: '/api/**:path', handler: _lazy_Sjstzh, lazy: true, middleware: false, method: undefined },
...
const ____path_ = defineEventHandler(async (event) => {
  ...
  return proxyRequest(event, `${target}${path}${incoming.search}`, {
    headers: {
      "x-forwarded-host": (_a = getRequestHeader(event, "host")) != null ? _a : "",
